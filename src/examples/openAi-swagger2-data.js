  ...
  paths: {
        ...
        parameters: [
          ...
          },
          {
            ...
            schema: {
              ...
              required: ["model", "messages", "tools", "tool_choice"],
            },
          },
        ],
        responses: {
    ...
    "/v1/fine_tuning/jobs": {
        ...
        parameters: [
          {
            ...
            schema: {
              ...
              properties: {
                ...
                model: {
                  type: "string",
                  description: "要微调的模型的名称。您可以选择支持的模型之一。",
                },
                hyperparameters: {
                  type: "object",
                  properties: {
              ...
              required: ["training_file", "model", "validation_file", "suffix"],
            },
          },
        ],
        responses: {
          200: {
            ...
            schema: {
              ...
              properties: {
                object: {
                  type: "string",
                  description: '对象类型,总是为"fine_tuning.job"',
                },
                id: {
                  type: "string",
                  description: "对象标识符,可以在API端点中引用",
                },
                model: {
                  type: "string",
                ...
                validation_file: {
                  type: "null",
                  description: "用于验证的文件ID。可以使用文件API检索验证结果",
                },
                training_file: {
                  type: "string",
                  description: "用于训练的文件ID。可以使用文件API检索训练数据",
                },
              },
              required: [
                "object",
      ...
      get: {
        summary: "列出微调作业",
        deprecated: false,
        description: "列出您组织的微调工作\n\n",
        tags: [],
        parameters: [
          {
            name: "after",
            in: "query",
            description: "上一个分页请求中最后一个作业的标识符。\n\n",
            required: false,
            type: "integer",
          },
          {
    ...
    "/v1/fine_tuning/jobs/{fine_tuning_job_id}/cancel": {
      post: {
        summary: "取消微调",
        deprecated: false,
        description: "立即取消微调工作。\n\n",
        tags: [],
        parameters: [
          {
            name: "fine_tuning_job_id",
            in: "path",
            description: "要取消的微调作业的 ID。\n\n",
            required: true,
            type: "string",
          },
        ],
    ...
    "/v1/fine_tuning/jobs/{fine_tuning_job_id}/events": {
      get: {
        summary: "列出微调事件",
        deprecated: false,
        description: "获取微调作业的状态更新。\n\n",
        tags: [],
        parameters: [
          {
            name: "fine_tuning_job_id",
            in: "path",
            description: "要为其获取事件的微调作业的 ID。\n\n",
            required: true,
            type: "string",
          },
          {
            name: "after",
            in: "query",
            description: "上一个分页请求中最后一个事件的标识符。\n\n",
            required: false,
            type: "string",
          },
          {
              ...
              "application/json": {
                ...
                data: [
                  ...
                  },
                  {
                    ...
                    level: "info",
                    message:
                      "New fine-tuned model created: ft:gpt-3.5-turbo:openai::7p4lURel",
                    data: null,
                    type: "message",
                  },
                ],
    ...
    "/v1/moderations": {
      post: {
        summary: "创建内容审核",
        deprecated: false,
        description: "对文本是否违反 OpenAI 的内容政策进行分类\n\n",
        tags: [],
        parameters: [
          {
            name: "Authorization",
        ...
        parameters: [
          {
            ...
            schema: {
              ...
              properties: {
                ...
                name: {
                  type: "string",
                  description: "助理的名字。最大长度为 256 个字符。",
                },
                description: {
                  type: "string",
                  description: "助理的描述。最大长度为 512 个字符。",
                },
                instructions: {
                  type: "string",
                  description: "助手使用的系统指令。最大长度为 32768 个字符。",
                },
                tools: {
                  type: "array",
                  items: {
                    ...
                    properties: {
                      type: {
                        type: "string",
                        description: "正在定义的工具类型：code_interpreter",
                      },
                    },
                  },
                  description:
    ...
    "/v1/assistants/{assistant_id}/files": {
      post: {
        ...
        deprecated: false,
        description:
          "[通过将File](https://platform.openai.com/docs/api-reference/files)附加到[助手](https://platform.openai.com/docs/api-reference/assistants)来创建助手文件。",
        tags: [],
        parameters: [
          {
            name: "assistant_id",
        ...
        responses: {
          200: {
            ...
            schema: {
              ...
              required: ["id", "object", "created_at", "assistant_id"],
            },
          },
        },
        security: [
      ...
      get: {
        ...
        deprecated: false,
        description:
          "返回辅助文件的列表。\n\n[辅助文件](https://platform.openai.com/docs/api-reference/assistants/file-object)对象的列表。",
        tags: [],
        parameters: [
          {
            name: "assistant_id",
            in: "path",
            description: "文件所属助手的ID。\n\n",
            required: true,
            type: "string",
          },
          {
    ...
    "/v1/assistants/{assistant_id}/files/{file_id }": {
      get: {
        ...
        deprecated: false,
        description:
          "检索 AssistantFile。\n\n与指定ID匹配的[辅助文件](https://platform.openai.com/docs/api-reference/assistants/file-object)对象。",
        tags: [],
        parameters: [
          {
            name: "assistant_id",
                ...
                messages: {
                  ...
                  items: {
                    ...
                    properties: {
                      role: {
                        type: "string",
                        description: "创建消息的实体的角色。目前仅user支持。",
                      },
                      content: {
                        type: "string",
                        description: "消息的内容。",
    ...
    "/v1/threads/{thread_id }": {
      post: {
        ...
        deprecated: false,
        description:
          "修改后的与指定ID匹配的[线程对象。](https://platform.openai.com/docs/api-reference/threads/object)",
        tags: [],
        parameters: [
          {
            name: "thread_id ",
            in: "path",
            description: "要修改的线程的ID。只能metadata修改。\n\n",
            required: true,
            type: "string",
          },
          {
          ...
          200: {
            ...
            schema: {
              ...
              properties: {
                ...
                created_at: {
                  type: "integer",
                  description: "创建消息时的 Unix 时间戳（以秒为单位）。",
                },
                thread_id: {
                  type: "string",
                  description: "该消息所属的线程ID 。",
                },
                role: {
                  type: "string",
                  description: "产生消息的实体。`user`或之一`assistant`。",
                },
                content: {
                  type: "array",
                  items: {
                    ...
                    properties: {
                      ...
                      text: {
                        ...
                        description: "作为消息一部分的文本内容。",
                      },
                    },
                  },
                  description: "文本和/或图像数组中的消息内容。",
                },
                file_ids: {
                  type: "array",
                  items: {
    ...
    "/v1/threads/{thread_id}/messages/{message_id }": {
      get: {
        ...
        deprecated: false,
        description:
          "与指定ID匹配的[消息](https://platform.openai.com/docs/api-reference/threads/messages/object)对象。",
        tags: [],
        parameters: [
          {
            name: "thread_id",
            in: "path",
            description: "该消息所属线程的ID 。\n\n",
            required: true,
            type: "string",
          },
          {
      ...
      post: {
        ...
        deprecated: false,
        description:
          "修改后的[消息](https://platform.openai.com/docs/api-reference/threads/messages/object)对象。",
        tags: [],
        parameters: [
          {
            name: "thread_id",
        ...
        responses: {
          200: {
            ...
            schema: {
              ...
              required: ["id", "object", "created_at", "message_id"],
            },
          },
        },
        security: [
    ...
    "/v1/threads/{thread_id}/runs": {
      post: {
        ...
        deprecated: false,
        description:
          "一个[运行](https://platform.openai.com/docs/api-reference/runs/object)对象。",
        tags: [],
        parameters: [
          {
            name: "thread_id",
            in: "path",
            description: "要运行的线程的 ID。\n\n",
            required: true,
            type: "string",
          },
          {
            ...
            schema: {
                    ...
                    properties: {
                      ...
                      "Retrieval tool": {
                        ...
                        properties: {
                          type: {
                            type: "string",
                            description: "正在定义的工具类型：retrieval",
                          },
                        },
                        required: ["type"],
                      },
                      "Function tool": {
                        ...
                        properties: {
                          type: {
                            type: "string",
                            description: "正在定义的工具类型：function",
                          },
                          function: {
                            type: "object",
                            properties: {
              ...
              required: ["assistant_id", "instructions", "model"],
            },
          },
        ],
        responses: {
      ...
      get: {
        ...
        deprecated: false,
        description:
          "[运行](https://platform.openai.com/docs/api-reference/runs/object)对象的列表。",
        tags: [],
        parameters: [
          {
            name: "thread_id",
            in: "path",
            description: "运行所属线程的 ID。\n\n",
            required: true,
            type: "string",
          },
          {
    ...
    "/v1/threads/{thread_id}/runs/{run_id }": {
      get: {
        ...
        deprecated: false,
        description:
          "与指定 ID 匹配的修改后的[运行对象。](https://platform.openai.com/docs/api-reference/runs/object)\n\n",
        tags: [],
        parameters: [
          {
            name: "thread_id",
            in: "path",
            description: "运行的线程的 ID 。\n\n",
            required: true,
            type: "string",
          },
          {
    ...
    "/v1/threads/{thread_id}/runs/{run_id}/submit_tool_outputs": {
      post: {
        ...
        deprecated: false,
        description:
          '当运行具有`status: "requires_action"`和`required_action.type`is时`submit_tool_outputs`，此端点可用于在工具调用全部完成后提交输出。所有输出必须在单个请求中提交。\n\n与指定 ID 匹配的修改后的[运行对象。](https://platform.openai.com/docs/api-reference/runs/object)\n\n',
        tags: [],
        parameters: [
          {
            name: "thread_id",
            in: "path",
            description: "此运行所属线程的 ID 。\n\n",
            required: true,
            type: "string",
          },
          {
                ...
                tool_outputs: {
                  ...
                  items: {
                    ...
                    properties: {
                      ...
                      output: {
                        type: "string",
                        description: "要提交以继续运行的工具调用的输出。",
                      },
                    },
                  },
                  description: "为其提交输出的工具列表。",
                },
              },
                  ...
                  properties: {
                    messages: {
                      ...
                      items: {
                        ...
                        required: ["role", "content", "metadata", "file_ids"],
                      },
                      description: "用于启动线程的消息列表。",
                    },
                    metadata: {
    ...
    "/v1 /threads/{thread_id}/runs/{run_id}/steps/{step_id}": {
      get: {
        ...
        deprecated: false,
        description:
          "与指定 ID 匹配的[运行步骤](https://platform.openai.com/docs/api-reference/runs/step-object)对象。",
        tags: [],
        parameters: [
          {
            name: "thread_id",
            in: "path",
            description: "运行和运行步骤所属线程的 ID。\n\n",
            required: true,
            type: "string",
          },
          {
